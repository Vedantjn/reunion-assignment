export const sampleData = [
  ...
  // If you want to use 'Product' type, you can define it as follows:
  // const data: Product[] = [...];
  
  // Exporting 'data' is not necessary in JavaScript
  // 'export' is used in modules, but if you're not working with modules, you can remove it
